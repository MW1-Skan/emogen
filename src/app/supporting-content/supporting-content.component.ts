        ...
        <div class="flex flex-col gap-10 lg:flex-row">
          ...
          <div class="flex-1 space-y-4">
            <div>
              ...
              <h3 id="emogen-faq-heading" class="text-2xl font-semibold text-white">
                Emoji generator questions
              </h3>
            </div>
            <div class="space-y-3">
      ...
      >
        <div class="space-y-6">
          <div class="space-y-3">
            ...
            <h3 id="emogen-press-heading" class="text-2xl font-semibold text-white">
